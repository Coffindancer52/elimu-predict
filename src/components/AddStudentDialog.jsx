                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
                  <div className="grid grid-2">
                    <div className="field">
                      ...
                      <input className="input" required placeholder="e.g. Mary Kamau" value={form.parentFullName} onChange={(e) => set("parentFullName", e.target.value)} maxLength={50}/>
                      {errors.parentFullName && <p style={errStyle}>{errors.parentFullName}</p>}
                    </div>
                    <div className="field">
